<li class="{{ $dir->type }} items hidden group bg-gradient-to-b from-white via-white to-gray-50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-800 rounded-lg shadow hover:shadow-md p-6 transition delay-100 duration-300 ease-in-out cursor-pointer">
